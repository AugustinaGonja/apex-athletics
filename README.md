...
* Clear call-to-action button for sign up.
...
* There is an option to sign up for a classess.

Tasks:
* Create "Training and Schedules" page highlighting all ongoings.
* Use Bootstrap to create a cohesive layout for training Schedules.
...
*All images will be linked to their original source in the [credits](#credits--code-used) section.*
...
I selected a favicon image that complements the site's theme and aligns with its color palette.
...
![Image showing Training Schedule Page on different devices](assets/images/TrainingScheduleimage.png)
...
---
**Contact Page**
![Image showing Contact Page on different devices](assets/images/contactimage.png)
...
Adjusted the distribution of my color palette to create a more visually appealing and readable site.
The **[previous site](assets/images/Homepage-previous.png)** lacked sufficient contrast between the header and the rest of the page, among other areas.
ChromeDevTools helped me identify this issue.

**Hover Effects on Buttons**

Added interactive hover effects to buttons to enhance user engagement.

**Font Choice**

Selected a bold yet readable **"Oswald"** font, consistently used throughout the site with varying weights and sizes to distinguish between sections.
...
## Testing
*Please refer to **[testing.md](testing.md)** document.<br>This will outline all of the testing and debugging processess*
## Technologies Used
...
* **[Bootstrap library](https://getbootstrap.com/)**<br>For layouts and specific features<br>*(I used Bootstrap mainly to create my Carousel & Tables).*

* **[Google Fonts](https://fonts.google.com/)**<br>To import the fonts used on the website.

* **ChromeDevTools**<br>To troubleshoot and test features, solve issues with responsiveness and styling.
...
* [Carousel & Card Image 1](https://www.google.com/url?sa=i&url=https%3A%2F%2Fm.facebook.com%2Fstory.php%3Fstory_fbid%3D122162818562107351%26id%3D61553220544140&psig=AOvVaw1hZhRFiI4Wc6eBFUOqtkzc&ust=1740418335240000&source=images&cd=vfe&opi=89978449&ved=0CBAQjRxqFwoTCNDow9yp2osDFQAAAAAdAAAAABAE)
